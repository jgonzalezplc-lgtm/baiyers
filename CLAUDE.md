...
- **Supplier Capability Intelligence, Fase 7 (local, sin commit/deploy todavía)**: continuidad completa sobre el flujo existente. Las respuestas Gmail (autoaplicadas o aprobadas manualmente), selección definitiva, aprobación limpia y compra completada generan evidencia idempotente; RFQs agrupadas resuelven resultado→proveedor; la aprobación inicia una sola conversación de compra por proveedor con sólo los ítems definitivos seleccionados; comparador, autorización, OC y lista de compra siguen siendo los existentes. No requiere migración.
